...
% Class Support:
% --------------
% All inputs must be real, nonsparse, numeric and of the same class.
% costMatrix may contain Inf entries to indicate that no assignment between
% a track and a detection is possible. costOfNonAssignment,
